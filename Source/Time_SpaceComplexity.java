public class Time_SpaceComplexity {
    public static void main(String[] args) {
        ...
        //Constant Time Complexity is always better than linear, logarithmic or exponential time complexity.

        // 1. O (Big Oh) represents the upper-bound of time-complexity for an algorithm, i.e., an algorithm of O(N^2) complexity can have time-complexity of O(N^2) or O(NlogN) or O(N) but it can never exceed O(N^2)

        //2. Big Omega (Opposite of Big O ) represents the lower-bound of time-complexity for an algo. I.e., an algo of BigOmega(N^2) will take minimum N^2 complexity (It may taken more than N^2 too) 

        //3. Theta Notation denotes both the upper-bound and lower-bound of time-complexity for an algo. E.g., Theta(N^2) represents an algo having the lower-bound and upper-bound complexity of N^2.
